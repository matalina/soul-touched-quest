...
<div class="row">
  ...
  <div class="form-group w-1/6">
    <input name="age" value={character.age} />
  ...
  <div class="form-group w-1/12">
    <input name="episodes" value={character.level.nextLevel.episodes} />
    <label for="episodes">Episodes</label>
  </div>
  <div class="form-group w-1/12">
    <input name="points" value={character.level.nextLevel.unspentPoints} />
...
<div class="row">
  <div class="form-group w-1/3">
    <input name="concept" value={character.concept} />
    <label for="concept">Concept</label>
  </div>
  <div class="form-group w-1/3">
    <input name="calling" value={character.calling} />
    <label for="calling">Calling</label>
  </div>
  <div class="form-group w-1/3">
    <input name="flaw" value={character.flaw} />
...
<div class="row">
  ...
  <div class="form-group w-1/3">
    <input name="profession" value={character.profession} />
    <label for="profession">Profession</label>
  </div>
  <div class="form-group w-1/6">
    <input name="profession-level" value={character.professionLevel} />
